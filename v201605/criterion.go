...
type KeywordCriterion struct {
	Id        int64  `xml:"https://adwords.google.com/api/adwords/cm/v201605 id,omitempty"`
	Text      string `xml:"https://adwords.google.com/api/adwords/cm/v201605 text,omitempty"`      // Text: up to 80 characters and ten words
	MatchType string `xml:"https://adwords.google.com/api/adwords/cm/v201605 matchType,omitempty"` // MatchType:  "EXACT", "PHRASE", "BROAD"
}
